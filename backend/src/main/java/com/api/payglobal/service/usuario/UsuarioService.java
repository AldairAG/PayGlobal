...
public interface UsuarioService extends UserDetailsService {
    ...
    void solicitarCompraLicencia(TipoCrypto tipoCrypto, TipoLicencia tipoLicencia, TipoSolicitud tipoSolicitud, Long idUsuario) throws Exception;

    void solicitarRetiroFondos(Long walletAddressId, BigDecimal monto,TipoSolicitud tipoSolicitud, Long idUsuario) throws Exception;

    void comprarLicenciaDelegada(TipoLicencia tipoLicencia, String destinatario, TipoMetodoPago tipoMetodoPago, Long idUsuario) throws Exception;

    void TransferenciaEntreUsuarios(String usuarioDestinatario, BigDecimal monto,TipoWallets tipoWallet, Long idUsuario) throws Exception;
