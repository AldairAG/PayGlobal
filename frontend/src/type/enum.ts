...
export enum TipoSolicitud {
    ...
    COMPRA_LICENCIA_PROMOCIONAL = "COMPRA_LICENCIA_PROMOCIONAL",
    COMPRA_LICENCIA_CON_WALLET_PAYGLOBAL = "COMPRA_LICENCIA_CON_WALLET_PAYGLOBAL",
    SOLICITUD_RETIRO_WALLET_STAKING = "SOLICITUD_RETIRO_WALLET_STAKING",
    SOLICITUD_RETIRO_WALLET_NETWORK = "SOLICITUD_RETIRO_WALLET_NETWORK",
    TRANFERENCIA_USUARIO = "TRANFERENCIA_USUARIO",
    PAGO_DELEGADO = "PAGO_DELEGADO",
    COMPRA_LICENCIA_MINERIA = "COMPRA_LICENCIA_MINERIA"
}
...
export enum TipoConceptos {
    ...
    TRANSFERENCIA_A_WALLET_PAYGLOBAL = "TRANSFERENCIA_A_WALLET_PAYGLOBAL"
}
